...
// int MetadataDecodePacketIPv6(metadata_to_suri_t *metadata_to_suri,
...
//     MetadataIpv6ConvertTo(&metadata_to_suri->metadata_ipv6.src_addr,
//             &metadata_to_suri_help->ipv6_hdr->src_addr[0]);
//     MetadataIpv6ConvertTo(&metadata_to_suri->metadata_ipv6.dst_addr,
//             &metadata_to_suri_help->ipv6_hdr->dst_addr[0]);

//     ret = MetadataDecodePacketL4((uint8_t *)metadata_to_suri_help->ipv6_hdr, metadata_to_suri,
//             metadata_to_suri_help, metadata_to_suri_help->ipv6_hdr->proto,
//             ipv6_raw_len - IPV6_HEADER_LEN, IPV6_HEADER_LEN);
