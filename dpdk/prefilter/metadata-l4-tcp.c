...
// static int MetadataDecodeTCPOptions(
//         uint8_t *pkt, metadata_to_suri_t *metadata_to_suri, uint8_t opt_len)
// {
...
//                     } else {
//                         if (metadata_to_suri->metadata_tcp.tcpVars.wscale != 0) {
//                             METADATA_SET_EVENT(metadata_to_suri, TCP_OPT_DUPLICATE);
//                         } else {
//                             SET_OPTS(metadata_to_suri->metadata_tcp.tcpVars.wscale,
...
//                         METADATA_SET_EVENT(metadata_to_suri, TCP_OPT_INVALID_LEN);
//                     } else {
//                         if (metadata_to_suri->metadata_tcp.tcpVars.mss != 0) {
//                             METADATA_SET_EVENT(metadata_to_suri, TCP_OPT_DUPLICATE);
//                         } else {
//                             SET_OPTS(metadata_to_suri->metadata_tcp.tcpVars.mss,
//                                     tcp_opts[tcp_opt_cnt]);
//                         }
//                     }
//                     break;
...
//                         METADATA_SET_EVENT(metadata_to_suri, TCP_OPT_INVALID_LEN);
//                     } else {
//                         if (metadata_to_suri->metadata_tcp.tcpVars.sack_ok != 0) {
//                             METADATA_SET_EVENT(metadata_to_suri, TCP_OPT_DUPLICATE);
//                         } else {
//                             SET_OPTS(metadata_to_suri->metadata_tcp.tcpVars.sack_ok,
//                                     tcp_opts[tcp_opt_cnt]);
//                         }
//                     }
//                     break;
...
//                         METADATA_SET_EVENT(metadata_to_suri, TCP_OPT_INVALID_LEN);
//                     } else {
//                         if (metadata_to_suri->metadata_tcp.tcpVars.sack_set != 0) {
//                             METADATA_SET_EVENT(metadata_to_suri, TCP_OPT_DUPLICATE);
//                         } else {
//                             SET_OPTS(metadata_to_suri->metadata_tcp.tcpVars.sack_set,
//                                     tcp_opts[tcp_opt_cnt]);
//                         }
//                     }
//                     break;
...
//                         METADATA_SET_EVENT(metadata_to_suri, TCP_OPT_INVALID_LEN);
//                     } else {
//                         if (metadata_to_suri->metadata_tcp.tcpVars.tfo_set != 0) {
//                             METADATA_SET_EVENT(metadata_to_suri, TCP_OPT_DUPLICATE);
//                         } else {
//                             SET_OPTS(metadata_to_suri->metadata_tcp.tcpVars.tfo_set,
//                                     tcp_opts[tcp_opt_cnt]);
//                         }
//                     }
//                     break;
...
// int MetadataDecodePacketTCP(metadata_to_suri_t *metadata_to_suri,
//         metadata_to_suri_help_t *metadata_to_suri_help, uint16_t len)
// {
//     uint16_t tcp_len;
//     int ret;
...
//     if (tcp_opt_len > 0) {
//         ret = MetadataDecodeTCPOptions((uint8_t *)metadata_to_suri_help->tcp_hdr + TCP_HEADER_LEN,
//                 metadata_to_suri, tcp_opt_len);
//         if (ret != 0) {
//             return ret;
//         }
//     }

//     metadata_to_suri->metadata_tcp.src_port =
//             rte_be_to_cpu_16(metadata_to_suri_help->tcp_hdr->src_port);
//     metadata_to_suri->metadata_tcp.dst_port =
//             rte_be_to_cpu_16(metadata_to_suri_help->tcp_hdr->dst_port);
